...
import MultiAnalysisRadarSuggest from '../components/MultiAnalysisRadarSuggest.vue'
    ...
    <main class="panel-layout multi-main">
      ...
      <section class="card io-panel multi-card-enter multi-hover-card multi-output-card" style="--delay: 0.15s">
        ...
        <div v-else-if="output" class="multi-output-inner multi-output-structured">
          ...
          <MultiAnalysisRadarSuggest
            v-model:hovered-axis="hoveredRadarAxis"
            class="multi-radar-suggest-above-summary"
            :output="output"
            :radar-polygon-points="radarPolygonPoints"
            :animated-radar="animatedRadar"
...
.multi-output-structured :deep(.multi-radar-suggest-above-summary.analysis-extra) {
  margin-top: 0;
  margin-bottom: 12px;
}
